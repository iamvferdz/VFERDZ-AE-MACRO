...
AUTO_PLAY_IMAGE = "auto_play"
AUTO_PLAY_WAIT_TIMEOUT = 1.0
SUMMER_PORTAL_CARD_SETTLE = 1.0
SUMMER_PORTAL_REWARD_IMAGE = "portal_reward_screen"
SUMMER_SELECT_PORTAL_IMAGE = "select_portal"
SUMMER_PORTAL_SELECTION_SELECT_IMAGE = "portal_selection_select"
SUMMER_PORTAL_SELECTION_REGION = (40, 70, 430, 180)
WEBHOOK_SEND_TIMEOUT = 120.0
SUMMER_PORTAL_BANNER_REGION = (250, 150, 650, 100)
SUMMER_PORTAL_CARD_MIDDLE = (460, 360)
# The three portal rewards occupy this band on the result overlay.  Matching
# the rendered portal image is more reliable than a fixed point because the
# overlay can move vertically with Roblox's client geometry.
SUMMER_PORTAL_CARD_REGION = (100, 220, 800, 260)
...
# Summer event: lobby Events -> Tidal Siege -> Event Gamemode, then either
# Event Mode (one stage) or Portal Mode (inventory -> portal -> activate).
SUMMER_MODE_ORDER = ["Event Mode", "Portal Mode"]
SUMMER_MODE_IMAGES = {
    "Event Mode": ("summer_event_mode",),
    "Portal Mode": ("summer_portal_mode",),
}
SUMMER_PORTAL_IMAGES = {
    ("Summer Portal", "1"): ("summer_portal_tier_1",),
    ("Summer Portal", "2"): ("summer_portal_tier_2",),
    ("Summer Portal", "3"): ("summer_portal_tier_3",),
    ("Summer Portal", "4"): ("summer_portal_tier_4",),
    ("Summer Portal", "5"): ("summer_portal_tier_5",),
    ("Summer Portal", "Secret"): ("sovereigns_portal",),
    ("Sky Ruins Portal", "1"): ("sky_ruins_portal_tier_1",),
    ("Sky Ruins Portal", "2"): ("sky_ruins_portal_tier_2",),
    ("Sky Ruins Portal", "3"): ("sky_ruins_portal_tier_3",),
    ("Sky Ruins Portal", "4"): ("sky_ruins_portal_tier_4",),
    ("Sky Ruins Portal", "5"): ("sky_ruins_portal_tier_5",),
    ("Sky Ruins Portal", "Secret"): ("lightning_gods_portal",),
}
SUMMER_TIDAL_SIEGE_IMAGE = "summer_tidal_siege"
SUMMER_EVENT_GAMEMODE_IMAGE = "event_gamemode"
SUMMER_ACTIVATE_PORTAL_IMAGE = "activate_portal"
SUMMER_SCREEN_TIMEOUT = 10.0
...
# Values are a tuple of candidate crops per type (any match wins), so a card
# shown in more than one visual state can still be matched.
...
# Portal repeats start through the Victory -> Select Portal -> Start Game
# chain. Roblox can briefly repaint the lobby's Play button while that
# transition is still settling; do not classify that transient frame as a
# failed repeat.
PORTAL_REPEAT_LOBBY_GRACE = 12.0
