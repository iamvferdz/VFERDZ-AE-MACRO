<p align="center">
  <img src="logo.ico" width="80" alt="VFERDZ — Anime Expeditions logo">
</p>

<h1 align="center">VFERDZ | Anime Expeditions</h1>
...
<p align="center">
  ...
  <a href="https://github.com/iamvferdz/VFERDZ-AE-MACRO">
...
<p align="center">
  <a href="https://github.com/iamvferdz/VFERDZ-AE-MACRO/actions/workflows/ci.yml">
    <img src="https://github.com/iamvferdz/VFERDZ-AE-MACRO/actions/workflows/ci.yml/badge.svg" alt="CI">
  </a>
  <a href="LICENSE">
...
1. Open the [**Releases page**](https://github.com/iamvferdz/VFERDZ-AE-MACRO/releases/latest)
2. The newest release is shown at the top
3. Under **Assets**, download **`VFERDZ-AE-MACRO-Windows.zip`** (or `VFERDZ-AE-MACRO-macOS.zip` on a Mac)
...
Releases also publish **`VFERDZ-AE-MACRO-macOS.zip`** (an Intel/x86_64 `.app` + the same editable `Assets/` folder), and source runs work via `./run.sh`. Key differences and setup:
